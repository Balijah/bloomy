...
export const BENCHMARK_DATA: Record<SupportedBenchmarkCrop, BenchmarkDataset> = {
  corn: {
    crop: "corn",
    cropLabel: "Corn",
    regionLabel: "Missouri / Midwest",
    seasonLabel: "2026 planning sample",
    sampleLabel: "Similar corn fields, 500-5,000 acre operations",
    yieldUnit: "bu/acre",
    priceUnit: "$/bu",
  ...
  soybeans: {
    ...
    regionLabel: "Missouri / Midwest",
    seasonLabel: "2026 planning sample",
    sampleLabel: "Similar soybean fields, 500-5,000 acre operations",
    yieldUnit: "bu/acre",
    priceUnit: "$/bu",
