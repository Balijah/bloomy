...
export const farmProfilesTable = pgTable("farm_profiles", {
  ...
  cropPrice: doublePrecision("crop_price"),
  costPerAcre: doublePrecision("cost_per_acre"),
  aphYield: doublePrecision("aph_yield"),
  insurancePlanType: text("insurance_plan_type"),
  coverageLevel: doublePrecision("coverage_level"),
  projectedPrice: doublePrecision("projected_price"),
  priceElection: doublePrecision("price_election"),
  notes: text("notes"),
